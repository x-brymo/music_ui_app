...
import 'package:music_ui_app/musice-app/gui/widgets/genres/custom_card_Genres.dart';
import '../../widgets/artiste/custom_card_artiste.dart';
import '../../widgets/genres/data_fake_2.dart';
          ...
          Expanded(
            child: GridView.builder(
                ...
                itemBuilder: (context, i) {
                  return Opacity(
                    opacity: i == mydata2.length - 1 ? 0.5 : 1.0,
                    child: CardGenres(genresData: mydata2[i])
                  );
                  // CardArtiste(
